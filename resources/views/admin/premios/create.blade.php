...
@section('title', 'Crear Premio - SEDIECOTECH Rewards')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Registra un nuevo premio disponible para canje</p>
        </div>
        <a 
    ...
    <!-- Form -->
    <form action="{{ route('admin.premios.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-lg shadow-md p-6 space-y-6">
            ...
            <div>
                ...
                >
                    ...
                    @foreach($institucionesProyectos as $ip)
                        <option value="{{ $ip->id }}" {{ old('institucion_proyecto_id') == $ip->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                >
                    ...
                    <option value="Canje por puntaje" {{ old('tipo') === 'Canje por puntaje' ? 'selected' : '' }}>Canje por puntaje</option>
                    <option value="Canje por Ranking" {{ old('tipo') === 'Canje por Ranking' ? 'selected' : '' }}>Canje por Ranking</option>
                </select>
                @error('tipo')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
