...
@section('title', 'Crear Anuncio - SEDIECOTECH Rewards')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Publica un nuevo anuncio para instituciones y proyectos</p>
        </div>
        <a 
    ...
    <!-- Form -->
    <form action="{{ route('admin.anuncios.store') }}" method="POST" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input 
                        ...
                        id="fecha_inicial" 
                        name="fecha_inicial" 
                        value="{{ old('fecha_inicial', now()->format('Y-m-d\TH:i')) }}"
                        required
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="fecha_final" 
                        name="fecha_final" 
                        value="{{ old('fecha_final', now()->addMonth()->format('Y-m-d\TH:i')) }}"
                        required
