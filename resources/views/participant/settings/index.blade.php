    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <a href="{{ route('participant.profile.index') }}" class="text-[#34A853] hover:text-green-700 text-sm font-medium">
                            Editar →
                        </a>
                    </div>
                    <div class="flex items-center justify-between py-3 border-b border-gray-200">
        ...
        <div class="space-y-6">
            <div class="bg-gradient-to-br from-[#34A853] to-green-600 rounded-xl shadow-lg p-6 text-white">
                ...
                <div class="space-y-3">
                    <a href="{{ route('participant.profile.index') }}" class="block p-3 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                        <div class="flex items-center">
                    ...
                    <a href="{{ route('participant.dashboard') }}" class="block p-3 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('participant.premios') }}" class="block p-3 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path>
                            </svg>
                            <span class="text-sm font-medium">Premios</span>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <h3 class="text-lg font-bold text-gray-800 mb-4">Ayuda y Soporte</h3>
                <div class="space-y-3 text-sm">
                    <a href="{{ route('home') }}" class="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <div class="flex items-center justify-between">
                            <span class="text-gray-700">Sitio Web Principal</span>
                    ...
                    <div class="p-3 bg-gray-50 rounded-lg">
                        <p class="text-gray-600 text-xs">
                            ¿Necesitas ayuda? Contacta con el administrador de tu institución o proyecto.
                        </p>
                    </div>
                </div>
            </div>
